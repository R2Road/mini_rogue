...
namespace r2
{
	...
	public:
		...
		void Reset( const std::size_t new_width, const std::size_t new_height )
		{
			...
			mContainer.clear();
			mContainer.resize( new_width * new_height );

			mIndexConverter = r2::GridIndexConverter( static_cast<int>( new_width ), static_cast<int>( new_height ) );
		}
		void Reset( const std::size_t new_width, const std::size_t new_height, const CellT fill_data )
		{
			...
			mContainer.clear();
			mContainer.resize( new_width * new_height, fill_data );
